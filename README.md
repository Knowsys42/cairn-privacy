...
the app itself is not open source.

`PRIVACY.md` is the source of truth and is mirrored from the app repository,
where a test fails if the two copies drift apart.
